...
function App() {
  const [isEditAvatarFormOpened, setIsEditAvatarFormOpened] = React.useState(
    false
  );
  const [isAddPlaceFormOpened, setIsAddPlaceFormOpened] = React.useState(false);
  const [isEditProfileFormOpened, setIsEditProfileFormOpened] = React.useState(
    false
  );
  const [
    isConfimDeleteFormOpened,
    setIsConfimDeleteFormOpened,
    ...
    <>
      <CurrentUserContext.Provider value={currentUser}>
        ...
        <EditProfilePopup
          ...
          onClose={closeAllPopups}
          onUpdateUser={handleUserProfileSubmit}
        />

        <EditAvatarPopup
          isOpened={isEditAvatarFormOpened}
          onClose={closeAllPopups}
          onUpdateAvatar={handleUserAvatarSubmit}
        />
